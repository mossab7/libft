...
/*   Updated: 2024/10/23 09:19:31 by mbouhia          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	// Testing ft_strcmp
	printf("\nTesting ft_strcmp:\n");
	print_test_result("ft_strcmp(\"abc\", \"abc\") == 0", ft_strcmp("abc",
			"abc") == 0);
	print_test_result("ft_strcmp(\"abc\", \"abd\") < 0", ft_strcmp("abc",
			"abd") < 0);
	print_test_result("ft_strcmp(\"abd\", \"abc\") > 0", ft_strcmp("abd",
			"abc") > 0);
	// Testing ft_substr
	printf("\nTesting ft_substr:\n");
	result = ft_substr("Hello, world!", 7, 5);
	print_test_result("ft_substr(\"Hello, world!\", 7, 5)", strcmp(result,
			"world") == 0);
	free(result);
	// Testing ft_strjoin
	printf("\nTesting ft_strjoin:\n");
	result = ft_strjoin("Hello, ", "world!");
	print_test_result("ft_strjoin(\"Hello, \", \"world!\")", strcmp(result,
			"Hello, world!") == 0);
	free(result);
	// Testing ft_strtrim
	printf("\nTesting ft_strtrim:\n");
	...
	// Testing ft_split
	printf("\nTesting ft_split:\n");
	split_result = ft_split("Hello world example", ' ');
	print_test_result("ft_split(\"Hello world example\", ' ') [0]",
		strcmp(split_result[0], "Hello") == 0);
	print_test_result("ft_split(\"Hello world example\", ' ') [1]",
		strcmp(split_result[1], "world") == 0);
	print_test_result("ft_split(\"Hello world example\", ' ') [2]",
		strcmp(split_result[2], "example") == 0);
	free(split_result[0]);
	free(split_result[1]);
	free(split_result[2]);
	free(split_result);
	...
	print_test_result("ft_strnstr(\"Hello, world!\", \"world\", 12)",
		strcmp(result, "world!") == 0);
	result = ft_strnstr("Hello, world!", "world", 5);
	print_test_result("ft_strnstr(\"Hello, world!\", \"world\", 5)",
		result == NULL);
	// Testing ft_strchr and ft_strrchr
	printf("\nTesting ft_strchr and ft_strrchr:\n");
	print_test_result("ft_strchr(\"Hello, world!\", 'w')",
		strcmp(ft_strchr("Hello, world!", 'w'), "world!") == 0);
	print_test_result("ft_strrchr(\"Hello, world!\", 'o')",
		strcmp(ft_strrchr("Hello, world!", 'o'), "orld!") == 0);
	...
	memchr_result = ft_memchr(memchr_src, 'e', 20);
	print_test_result("ft_memchr", memchr_result != NULL
		&& memchr_result[0] == 'e');
	...
	printf("\nTesting ft_strdel and ft_strnew:\n");
	strnew_result = ft_strnew(10);
	print_test_result("ft_strnew(10)", strnew_result != NULL
		&& ft_strlen(strnew_result) == 10);
	ft_strdel(&strnew_result);
	print_test_result("ft_strdel(&strnew_result) - memory freed",
		strnew_result == NULL);
