...
# Source files
SRCS = ft_atoi.c  ft_split.c ft_strdup.c ft_strclr.c ft_putendl_fd.c ft_substr.c ft_strmapi.c\
       ...
       ft_strrchr.c ft_strndup.c ft_putchar.c ft_putstr.c ft_putendl.c ft_itoa.c \
       ft_putnbr.c ft_strjoin.c ft_strnstr.c ft_putstr_fd.c ft_putnbr_fd.c ft_putchar_fd.c ft_striteri.c \
